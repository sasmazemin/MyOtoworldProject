...
class InspectionFirmDetailActivity : AppCompatActivity(), DateTimePickerFragment.DateTimePickerListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firm?.let {
            ...
            val inspectionWorkingHours = it.inspectionWorkingHours.split("-")

            val openingTime = inspectionWorkingHours[0] // "09:00"
            val closingTime = inspectionWorkingHours[1] // "20:00"
...
// Opening ve Closing Time'ları Date objesine çevir
            ...
            if (openingDate != null && closingDate != null) {
                ...
                if (currentTime.after(openingCalendar) && currentTime.before(closingCalendar)) {
                    ...
                    binding.textView20.text="OPEN"// Çalışma saatleri içerisindeyse
                } else {
                    binding.imageView29.setImageResource(R.drawable.eclipse_red_firm_closed)
                    binding.textView20.setTextColor(getResources().getColor(R.color.mainColor))
                    binding.textView20.text="CLOSED"// Çalışma saatleri içerisinde değilse
                }
            }
            ...
            imageList.add(SlideModel(it.inspectionImageUrl, ScaleTypes.FIT))
