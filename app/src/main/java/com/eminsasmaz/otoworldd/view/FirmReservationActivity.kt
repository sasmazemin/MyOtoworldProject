...
class FirmReservationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (firmId == null || firmType == null) {
            Toast.makeText(this, "Firm bilgisi alınamadı.", Toast.LENGTH_SHORT).show()
            finish()
            return
        }

        setupRecyclerView()
        fetchReservations(firmId, firmType)
    }
    ...
    private fun updateReservationStatus(reservation: ReservationModel, newStatus: String) {
        ...
        firestore.collection("CarparkFirms")
            ...
            .addOnSuccessListener {
                firestore.collection("Users")
                    ...
                    .addOnSuccessListener {
                        ...
                        fetchReservations(reservation.firmId!!, "CarparkFirms")
                    }
    ...
    private fun fetchReservations(firmId: String, firmType: String) {
        firestore.collection(firmType)
            .document(firmId)
            .collection("Reservations")
            .get()
